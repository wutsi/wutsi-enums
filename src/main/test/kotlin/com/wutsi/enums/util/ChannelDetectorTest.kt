...
internal class ChannelDetectorTest{
    ...
    private fun detect(url :String = "https://www.wutsi.com/p/1", referer:String="http://www.googl.ecom", ua:String=UA) =
    ...
    @Test
    fun twitterUA() {
        val channel = detect(ua = "Mozilla/5.0 (iPhone; CPU iPhone OS 15_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/14F89 Twitter for iPhone/7.21.1")
        assertEquals(ChannelType.SOCIAL, channel)
    }
    ...
    @Test
    fun facebookUA() {
        val channel = detect(ua = "Mozilla/5.0 (iPhone; CPU iPhone OS 16_1_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/20B101 [FBAN/FBIOS;FBDV/iPhone12,1;FBMD/iPhone;FBSN/iOS;FBSV/16.1.1;FBSS/2;FBID/phone;FBLC/en_US;FBOP/5]")
        assertEquals(ChannelType.SOCIAL, channel)
    }
